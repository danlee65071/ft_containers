...
Другими словами, при наличии двунаправленного итератора std::reverse_iteratorсоздает новый итератор, который перемещается от конца к началу последовательности, определенной базовым двунаправленным итератором.
